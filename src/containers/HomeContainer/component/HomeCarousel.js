        ...
        return (
            <div className="home_banner_box">
                <Carousel afterChange={onChange} autoplay>
                    ...
                    <div><img width="100%" height="auto" src={walle2} alt="banner" /></div>
                    <div><img width="100%" height="auto" src={walle3} alt="banner" /></div>
                    <div><img width="100%" height="auto" src={walle4} alt="banner" /></div>
                </Carousel>
            </div>
        )
    }
